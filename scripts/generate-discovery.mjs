...
<meta name="robots" content="index,follow,max-image-preview:large"><title>Todas as análises e ofertas | Ranking da Compra</title>
<meta name="description" content="Encontre todas as análises de produtos do Ranking da Compra, organizadas por categoria, com preços informados, pontos positivos e pontos de atenção.">
<link rel="canonical" href="${SITE}analises.html"><meta property="og:type" content="website"><meta property="og:title" content="Todas as análises e ofertas | Ranking da Compra"><meta property="og:description" content="Diretório permanente de análises para comparar antes de comprar."><meta property="og:url" content="${SITE}analises.html"><meta property="og:image" content="${SITE}og-ranking-da-compra.png"><meta name="theme-color" content="#0f3d2e"><script type="application/ld+json">${structuredData}</script>

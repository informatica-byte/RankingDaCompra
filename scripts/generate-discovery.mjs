...
const GROWTH_TOOLS_VERSION = "20260919-metrics-compat1";
...
const GUIDE_SLUGS_BY_LEGACY_ID = {
  belezaecuidados: "beleza-cuidados-e-saude",
  caixadesom: "caixa-de-som",
  camerasdeseguranca: "cameras-de-seguranca",
  fonesdeouvido: "fones-de-ouvido",
  fritadeiraairfrayereletrica: "fritadeira-air-fryer-eletrica",
  kitbodysplashmasculino: "kit-body-splash-masculino",
  kittecladoemousesemfio: "kit-teclado-e-mouse-sem-fio",
  smarttv: "smart-tv",
};
...
function guideFileName(categoryId, categoryName = "") {
  ...
  if (publicSlug.includes("patinete")) return "melhores-patinetes-eletricos.html";
  return `melhores-${publicSlug}.html`;
}

...
has(homeHtml, /growth-tools\.js\?v=20260919-video2/, "versão nova das ferramentas da vitrine não foi ativada", "index.html");
...
has(dashboardHtml, /growth-tools\.js\?v=20260919-video2/, "painel e vitrine usam versões diferentes das ferramentas", "dashboard.html");
...
has(sitemapGenerator, /<script defer src="\/growth-tools\.js\?v=20260919-video2"><\/script>/, "versão atual do corretor editorial não foi incluída nas novas páginas de produto", "scripts/generate-sitemap.mjs");
...
for (const url of urls) {
  ...
  has(html, /growth-tools\.js\?v=(?:20260913-seo1|20260919-video1|20260919-video2)/, "versão visual desconhecida carregada", relative);
